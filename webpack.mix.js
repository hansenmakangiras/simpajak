...
mix.sass('resources/sass/assets/structure.scss', 'public/assets/css/')
    ...
    */
    ...
    .sass('resources/sass/plugins/table/datatable/datatables-dark.scss', 'public/plugins/table/datatable/')
    .sass('resources/sass/plugins/table/datatable/dt-global_style.scss', 'public/plugins/table/datatable/')
    .sass('resources/sass/plugins/table/datatable/dt-global_style-dark.scss', 'public/plugins/table/datatable/')
