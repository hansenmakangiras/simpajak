...
if (!function_exists('setTitle')) :
    function setTitle($page_name) {
        ...
        $admin_name = '| SIMPAJAK - Sistem Informasi Managemen Pajak Online';

        if ($page_name === 'dashboard') :
            echo 'SIMPAJAK - Sistem Informasi Managemen Pajak Online';
        elseif ($page_name === 'users_list') :
            echo 'List Pengguna ' . $admin_name;
